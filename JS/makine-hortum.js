...
function intgetir() {
    ...
    //! BOX IMG COLOR
    document.getElementById("img-1-h").style.boxShadow = "1px 1px 9px 2px rgb(18 119 178)"
}
...
function imgChange(number) {
    ...
    var numbImg = document.getElementById("img-" + number + "-h");

    mainImg.innerHTML = numbImg.innerHTML;

    for (var a in list) {
        document.getElementById("img-" + list[a] + "-h").style.boxShadow = "1px 1px 9px -2px #686c6e"
    }
