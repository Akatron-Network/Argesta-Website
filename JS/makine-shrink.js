...
function intgetir() {
    ...
    //! BOX IMG COLOR
    document.getElementById("img-1-s").style.boxShadow = "1px 1px 9px 2px rgb(18 119 178)"
}
...
function imgChange(number) {
    ...
    var numbImg = document.getElementById("img-" + number + "-s");

    mainImg.innerHTML = numbImg.innerHTML;

    for (var a in list) {
        document.getElementById("img-" + list[a] + "-s").style.boxShadow = "1px 1px 9px -2px #686c6e"
    }
